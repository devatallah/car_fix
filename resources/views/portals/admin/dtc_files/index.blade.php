        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">@lang('dtc_files')</h2>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="head-label">
                                    <h4 class="card-title">DTC Files ID: - {{ $dtc->id }}</h4>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" id="create_form" method="POST" data-reset="true" class="ajax_form form-horizontal"
                        ...
                        {{ csrf_field() }}
                        <input type="hidden" name="dtc_uuid" value="{{ $dtc->uuid }}">
                        <div class="row">
                            <div class="col-6">
...
@section('scripts')
    <script>
        var url = '{{ url('/admin/dtc_files') }}/';
        var url2 = '{{ url('/admin/dtc_files') }}';
        ...
        var oTable = $('#datatable').DataTable({
            ...
            searching: false,
            ajax: {
                url: '{{ url('/admin/dtc_files/indexTable/'.$dtc->uuid) }}',
            },
            columns: [{
