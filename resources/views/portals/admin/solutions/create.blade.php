                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ url('/admin/solutions') }}">@lang('solutions')</a>
                                </li>
                            </ol>
                        </div>
                    </div>
    ...
    margin-top: 0.45rem; margin-left: -1.15rem;">
                                        ...
                                        <div class="col-6 mt-1">
                                            ...
                                            <div id="results" class="form-group ps-1 mt-1 pt-1 mb-1"
                                                ...
                                                <p><b style="font-size:large;">Selected Module: </b> <span
                                                        id="module_result"></span></p>
                                                <p><b style="font-size:large;">Selected Brand: </b> <span
                                                        id="brand_result"></span></p>
                                                <p><b style="font-size:large;">Selected ECU: </b> <span
                                                        id="ecu_result"></span></p>
                                                <p><b style="font-size:large;">Selected File: </b> <span
                                                        id="file_result"></span></p>
                                                <p><b style="font-size:large;">File Size: </b> <span
                                                        id="file_size_result"></span></p>
                                            </div>
                                        </div>
            ...
            <div class="modal-dialog modal modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('/user/ecu_request') }}" id="create_form" method="POST" data-reset="true"
