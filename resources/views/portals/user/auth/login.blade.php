...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('portals/app-assets/css/core/menu/menu-types/vertical-menu.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('portals/app-assets/css/plugins/forms/form-validation.css') }}">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="index.html" class="brand-logo">
                                    <img src="{{ asset('landing/assets/images/landpage/svg/logo3.svg') }}" style="width: 120px"
                                        alt="">
                                </a>
                                    ...
                                    <div class="mb-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="login-email" name="email"
                                                placeholder="@lang('email')" aria-describedby="login-email"
